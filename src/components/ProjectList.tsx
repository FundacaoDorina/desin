      ...
      <div className="bg-sidebar-light p-2 rounded w-full md:w-fit md:max-w-[200px] lg:max-w-[250px]">
        <div className="bg-sidebar-dark px-2 py-1 mb-1 rounded">
          <h2
            ...
            tabIndex={0}
            className="text-card-foreground font-bebas font-bold text-lg leading-none rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            Projetos
          </h2>
        </div>
    ...
    <div className="space-y-6 md:space-y-8 lg:space-y-10 w-full block">
      <div className="bg-primary inline-block px-6 py-3 md:px-8 md:py-4">
        <h2
          id="lista-projetos-titulo"
          tabIndex={0}
          className="text-primary-foreground font-bebas font-bold text-4xl md:text-5xl lg:text-6xl rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
          Projetos
        </h2>
      </div>
